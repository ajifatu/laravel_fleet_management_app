...
<head>
    ...
    <title>Almawoto</title>
    <link rel="icon" href="{{ asset('user/img/Almawoto-logo.png') }}" sizes="50">
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-4 ps-3 d-flex flex-column justify-content-around">
                    <div class="row px-3">
                        ...
                        <p class="fs-3 fw-bold">{{ $car->brand }}</p>
                        <p class="fs-3 fw-semibold" style="color: gray;">{{ $car->price }}FCFA /jour</p>
                    </div>
                    <form action="{{ route('add_order', $car) }}" method="post" class="">
                        ...
                        <div class="row px-3">
                            ...
                            <div class="date-input">
                                <label for="text" class="fs-4 fw-semibold mb-1" style="color: #0d7c5d;">
                                    De:</label>
                                    <textarea name="location" class="form-control" rows="1"></textarea>

                            </div>
                            <div class="date-input">
                                <label for="text" class="fs-4 fw-semibold mb-1" style="color: #0d7c5d;">
                                    Vers:</label>
                                    <textarea name="destination" class="form-control" rows="1"></textarea>
                            </div>
                        </div>
    ...
    <div class="container-lg">
        <div class="card border-0 shadow-lg rounded mt-5">
            <h5 class="ms-3 mt-4 text-center">Détails de la voiture</h5>
            <hr>
            <div class="detail-product row text-center">
                ...
                <div class="col-lg-3 col-6">
                    <p class="mb-1">Kilométrage</p>
                    <p>{{ $car->fuel }} km</p>
                </div>
                <div class="col-lg-3 col-6">
                    <p class="mb-1">Chauffeur</p>
                    <p>Mamadou Ndiaye</p>
                </div>
                <div class="col-lg-3 col-6">
