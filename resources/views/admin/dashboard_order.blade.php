...
<body>
    ...
    <main>
        <div class="head-title">
            ...
            <div>
                <p>Inventaire des réservations. </p>
            </div>
            ...
            <div class="order">
                ...
                @foreach ($orders as $order)
                    <div class="container">
                        ...
                        <p>Client : {{ $order->payment->user->name }}</p>
                        <p>Chauffeur : {{ $order->driver }}</p>
                        <p>De {{ $order->location }} vers {{ $order->direction }}</p>
                        ...
                        @if ($order->payment->payment_receipt == null)
                           Pas de paiement
                        @else
                            <a href="{{ url('storage/' . $order->payment->payment_receipt) }}">Consulter / télécharger</a>
