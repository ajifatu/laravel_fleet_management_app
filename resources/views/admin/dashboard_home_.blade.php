        ...
        <div class="table-data">
            <div class="order">
                <div class="head">
                    ...
                    @endphp
                    @if ($segment == 'week')
                        <h3>États financiers hebdomadaires</h3>
                    @elseif ($segment == 'month')
                        <h3>États financiers mensuels</h3>
                    @elseif ($segment == 'year')
                        <h3>États financiers annuels</h3>
                    @endif
                    <button onclick="openModal()" class="btn-pdf">Télécharger
                        PDF</button>
                    <a href="{{ route('dashboard_home_', ['range' => 'week']) }}" class="btn btn-primary">Cette semaine</a>
                    <a href="{{ route('dashboard_home_', ['range' => 'month']) }}" class="btn btn-primary">Ce
                        Mois
                        </a>
                    <a href="{{ route('dashboard_home_', ['range' => 'year']) }}" class="btn btn-primary">Cette année
                        </a>
                </div>
                <table>
                    <thead>
