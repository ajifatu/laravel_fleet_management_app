...
-88z"/>
                ...
                <div class="mt-4 w-75 login-content">
                    ...
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="login-btn d-flex justify-content-center mt-5">
                            <button class="btn btn-login btn-lg px-5 py-2 rounded-pill " type="submit">Connexion</button>
                        </div>
                    </form>
    ...
    <script>
        ...
        // Afficher le contenu de connexion, masquer inscription lorsque la page est chargée
        loginLink.classList.add("curBackground");
        loginContent.classList.remove("hidden");
        registerContent.classList.add("hidden");

        // Afficher le contenu de connexion lorsque le lien "Connexion" est cliqué
        ...
        // Afficher le contenu d'inscription pendant le lien "inscription" est cliqué
