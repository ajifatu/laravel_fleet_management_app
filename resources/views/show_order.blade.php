                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-3">
                        <div class="card-body">
                            ...
                            @if ($order->location) 
                                <p class="card-text return-date"> {{ $order->location }}</p>
                            @else
                                <p class="card-text return-date"> Thies</p>
                            @endif
                            <h5 class="card-title">Vers:</h5>
                            @if ($order->destination) 
                                <p class="card-text return-date"> {{ $order->destination }}</p>
                            @else
                                <p class="card-text return-date"> Saint Louis</p>
                            @endif
                        </div>
                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-select" id="inputGroupSelect01">
                                                        ...
                                                        <option value="1">WAVE - 77 815 31 91</option>
                                                        <option value="2">Free Money - 76 982 38 27</option>
                                                        <option value="3">Orange Money - 77 815 31 91</option>
                                                    </select>
                                                </div>
