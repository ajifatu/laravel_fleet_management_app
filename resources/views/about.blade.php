...
<head>
    ...
    <title>A Propos de almawoto
    </title>
    <link rel="icon" href="Almawoto-logo.png" sizes="50" />
...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">A Propos de <span class="text-success">Almawoto</span></h1>
                ...
                <div class="col-lg-10 text-center">
                    ...
                    <div class="d-flex align-items-center p-4 mb-4 text-dark">
                        <p>
                            ...
                            Almawoto est une plate-forme de location de voitures en ligne qui fournit des services de haute qualité
                            Pour les clients
            ...
            <div class="row">
                <div class="col-lg-4 mb-2">
                    ...
                    <p class="text-dark  text-justify">
                        Almawoto offre une commodité et un confort aux clients dans la location d'une voiture.Via ce site,
                ...
                <div class="col-lg-4 mb-2">
                    ...
                    <p class="text-dark text-justify">Almawoto promet la rapidité et la sécurité dans le processus
                        de location.
                ...
                <div class="col-lg-4 mb-2">
                    ...
                    <p class="text-dark text-justify">
                        Almawoto propose une variété de choix de véhicules, allant de voitures familiales confortables à
                        voiture de luxe
