...
<body>
    <header class="clearfix" style="margin-top: 20px; ">
        ...
        <div id="company">
            <h2 class="name">Almawoto services</h2>
            <div></div>
            <div>+221 778153191</div>
            <div><a href="mailto:company@example.com">almawoto@gmail.com</a></div>
        </div>
    </header>
    <br>
    <main>
        @foreach ($orders as $order)
            ...
            <div id="thanks">Nous tenons à vous remercier de votre confiance dans l'utilisation de nos services.</div>
            <div id="notices">
                <div>NOTICE:</div>
