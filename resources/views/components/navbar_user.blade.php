    ...
    <nav class="navbar navbar-expand-md bg-body-tertiary sticky-top shadow-sm">
        ...
        <div class="container-sm navbar-resp-large">
            ...
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                ...
                <path d="M3588 2826 c-105 -39 -132 -90 -132 -251 0 -137 20 -190 89 -231 98
                -57 260 -40 328 35 43 48 51 89 45 234 -4 120 -21 158 -90 197 -53 30 -181 38
                -240 16z m112 -251 c0 -57 -4 -95 -10 -95 -6 0 -10 38 -10 95 0 57 4 95 10 95
                6 0 10 -38 10 -95z"/>
                <path d="M4455 2831 c-44 -11 -70 -27 -99 -61 -35 -42 -46 -89 -46 -200 1
                -140 23 -190 105 -234 33 -17 57 -21 130 -21 174 1 235 68 235 261 0 151 -44
                227 -146 253 -47 12 -133 13 -179 2z m100 -254 c0 -120 -19 -118 -23 1 -2 73
                0 93 10 90 9 -3 13 -29 13 -91z"/>
                <path d="M1368 2578 l-3 -251 -60 96 c-64 103 -85 112 -85 36 0 -25 -7 -46
                -19 -58 -19 -19 -19 -20 6 -56 l26 -38 105 7 c58 3 158 6 224 6 l118 0 0 75 0
                75 -45 0 -45 0 0 180 0 180 -110 0 -110 0 -2 -252z"/>
                <path d="M1700 2575 l0 -255 90 0 c50 0 90 1 90 3 0 1 -7 58 -15 127 -17 147
                -17 140 -7 140 4 0 16 -51 26 -112 27 -174 17 -158 101 -158 l73 0 11 63 c6
                34 16 95 22 135 7 39 16 72 20 72 5 0 9 -1 9 -2 0 -2 -7 -59 -15 -128 -8 -69
                -15 -128 -15 -132 0 -5 41 -8 90 -8 l90 0 0 255 0 255 -129 0 -128 0 -7 -31
                c-3 -17 -6 -57 -6 -89 0 -31 -3 -79 -7 -106 -8 -64 -21 -33 -22 56 -1 36 -4
                89 -7 118 l-7 52 -128 0 -129 0 0 -255z"/>
                <path d="M2347 2587 c-31 -133 -57 -248 -57 -255 0 -9 28 -12 105 -12 l105 0
                0 26 c0 33 33 30 38 -4 3 -21 7 -22 108 -22 96 0 105 2 100 18 -7 23 -116 481
                -116 487 0 3 -51 5 -113 5 l-112 0 -58 -243z m182 -75 c1 -31 -3 -42 -11 -39
                -13 4 -14 16 -9 110 l3 52 9 -40 c4 -22 8 -59 8 -83z"/>
                <path d="M2756 2813 c2 -10 24 -117 49 -238 26 -121 48 -228 51 -237 5 -16 19
                -18 113 -18 l108 0 7 46 c3 26 6 79 7 118 0 49 3 65 9 51 5 -11 9 -64 9 -117
                l1 -98 113 0 113 0 52 248 c29 136 52 251 52 255 0 4 -47 7 -103 7 l-104 0 -6
                -97 c-4 -54 -7 -124 -7 -156 0 -36 -4 -56 -10 -52 -5 3 -10 43 -10 88 0 45 -3
                112 -7 150 l-6 67 -93 0 -94 0 -1 -97 c-1 -100 -14 -234 -19 -198 -1 11 -5 81
                -9 155 l-6 135 -107 3 c-98 2 -106 1 -102 -15z"/>
                <path d="M3940 2755 l0 -75 35 0 35 0 0 -180 0 -180 105 0 105 0 2 178 3 177
                33 3 32 3 0 75 0 74 -175 0 -175 0 0 -75z"/>
                <path d="M842 2693 l-80 -128 33 -3 c19 -2 44 3 57 11 13 8 34 17 48 20 17 4
                34 23 53 57 16 27 31 50 35 50 5 0 21 -22 37 -50 16 -27 34 -50 39 -50 5 0 29
                -9 52 -21 24 -11 56 -19 72 -17 l29 3 -80 128 -79 127 -68 0 -68 0 -80 -127z"/>
                <path d="M885 2561 c-12 -5 -26 -16 -33 -24 -8 -10 -26 -14 -45 -13 -18 2 -24
                1 -14 -1 18 -5 24 -33 7 -33 -5 0 -10 -16 -10 -36 0 -27 5 -37 20 -41 11 -3
                20 -12 20 -19 0 -9 11 -14 30 -14 20 0 30 5 30 15 0 12 18 15 100 15 82 0 100
                -3 100 -15 0 -10 10 -15 30 -15 19 0 30 5 30 14 0 8 9 18 20 21 25 8 27 51 4
                77 -14 14 -14 18 -3 22 38 12 41 16 9 12 -26 -3 -41 2 -58 18 -20 18 -37 21
                -120 23 -53 2 -106 -1 -117 -6z"/>
                <path d="M672 2421 c-34 -54 -62 -102 -62 -105 0 -3 31 -6 70 -6 70 0 70 0 93
                38 23 36 24 37 6 50 -14 9 -19 26 -19 56 0 24 -6 49 -13 55 -11 9 -26 -9 -75
                -88z"/>
                </g>
                </svg>
            ...
            <div class="collapse navbar-collapse justify-content-end me-5" id="navbarNav">
                <ul class="navbar-nav fw-semibold">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('index_car') }}">Véhicules</a>
                    </li>
                    <li class="nav-item">
            ...
            @guest
                <div class="guest ms-4">
                    @if (Route::has('login'))
                        <a class="btn btn-rent rounded-5" href="{{ route('login') }}">Se connecter</a>
                    @endif
                    @if (Route::has('register'))
                        <a class="btn btn-light rounded-5 border" href="{{ route('register') }}">S'inscrire</a>
                    @endif
                </div>
            @else
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 rounded shadow-lg p-0">
                        @if (Auth::user()->is_admin)
                            <li class="dropdown-item px-4 py-2 rounded-top dropdown-link">
                                <a class="text-decoration-none fw-semibold" href="{{ route('dashboard_home') }}">Tableau de bord
                                    </a>
                            </li>
                        @endif
                        <li class="dropdown-item px-4 py-2 rounded-top dropdown-link">
                            <a class="text-decoration-none fw-semibold" href="{{ route('index_user') }}">Mon compte</a>
                        </li>
                        <li class="dropdown-item px-4 py-2 dropdown-link">
                            <a class="text-decoration-none fw-semibold" href="{{ route('show_order') }}">Mes réservations</a>
                        </li>
            ...
            @if (Auth::user())
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu border-0 rounded shadow-lg p-0">
                        ...
                        <li class="dropdown-item px-4 py-2 rounded-top dropdown-link">
                            <a class="text-decoration-none fw-semibold" href="{{ route('index_user') }}">Compte</a>
                        </li>
                        <li class="dropdown-item px-4 py-2 dropdown-link">
                            <a class="text-decoration-none fw-semibold"
                                href="{{ route('show_order') }}">Réservation</a>
                        </li>
                        <li class="dropdown-item px-4 py-2 rounded-bottom dropdown-link">
                            <a class="text-decoration-none fw-semibold" href="{{ route('logout') }}"
                                onclick="event.preventDefault();
            ...
            <div class="collapse navbar-collapse justify-content-end me-5" id="navbarNav">
                <ul class="navbar-nav fw-semibold">
                    ...
                    <div class="guest mb-3 mt-3">
                        @if (!Auth::user())
                            @if (Route::has('login'))
                                <a class="btn btn-rent rounded-5" href="{{ route('login') }}" style="width: 45%">Connexion</a>
                            @endif
                            @if (Route::has('register'))
                                <a class="btn btn-light rounded-5 border" href="{{ route('register') }}"
                                    style="width: 45%">Inscription</a>
                            @endif
                        @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('about') }}">APropos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('faq') }}">FAQ</a>
                    </li>
