...
<head>
    ...
    <title>Contactez Almawoto</title>
                    ...
                    <div class="d-flex flex-column justify-content-center px-5 mb-4"
                        ...
                        <div class="d-flex mb-4 mt-4">
                            ...
                            <div class="mt-n1">
                                ...
                                <a class="text-decoration-none" href="https://goo.gl/maps/"
                                    style="color: #8486a0">Almawoto Services</a>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-4 mt-4">
                            ...
                            <div class="mt-n1">
                                ...
                                <a class="text-decoration-none" href="mailto:adjifatou@gmail.com"
                                    style="color: #8486a0">adjifatou@gmail.com</a>
                            </div>
                        </div>
                        <div class="d-flex mb-4 mt-4">
                            ...
                            <div class="mt-n1">
                                ...
                                <a class="m-0 text-decoration-none" href="tel:+221 778153191"
                                    style="color: #8486a0">+222
                                    778153191</a>
                            </div>
                        </div>
                    </div>
