...
<head>
    ...
    <link rel="icon" href="{{ asset('user/img/Almawoto-logo.png') }}" sizes="100">
...
<body>
    ...
    <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('user/img/slider4.jpeg') }}" class="d-block w-100 img-fluid" alt="...">
            </div>
    ...
    <div class="rent container-lg mt-5">
        <h2 style= "font-weight: bold">Nous vous recommendons: </h2>
