...
<body>
    ...
    {{-- <div class="hero">
        <div class="row">
            <div class="col-md-6">
                <div>
                    <br>
                    <h1 class="hero__title" style="margin-left: 20px" style="margin-top: 20px">
                        UNE LARGE GAMME DE VOITURE VOUS ATTEND !
                    </h1>
    ...
    <!-- RENT -->
    <div class="rent container-lg mt-10 riwayat-body">
        <h1 style= "font-weight: bold">  </h1>
            <div class="row mt-1">
                @foreach ($cars as $car)
                <div class="col-lg-4 col-sm-6 mt-4">
                    <div class="card border-0 shadow-lg">
                        {{-- <img src="/Users/macbookpro/Desktop/L3GL/LARAVEL/CODE/ParcAuto_Gestion-Laravel/storage/app/public/1710179675_Yamaha YZF.jpeg" class="card-img-top" alt="..."> --}}
